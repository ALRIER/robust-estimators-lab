...
def research_logic_svg(panel: int) -> str:
    ...
    p = ['<rect x="20" y="16" width="1560" height="744" rx="18" class="canvas"/>', _t(48, 56, "01 · RESEARCH LOGIC", "kicker"), _t(48, 100, headings[panel], "title"), _t(48, 137, claims[panel], "claim")]
    ...
    def rail(lines, why, next_):
        card(1260,170,300,545,"WHAT THIS MEANS",lines,"rail"); p.extend([_t(1280,310,"WHY IT MATTERS","kicker"),_t(1280,340,why,"railtext"),_t(1280,410,"NEXT","kicker"),_t(1280,440,next_,"railtext")])
    if panel == 0:
    ...
    css='''body{margin:0;background:#081525;font-family:Arial,sans-serif}svg{width:100%;height:760px}.canvas{fill:#091a2e;stroke:#2d6d9c;stroke-width:1.5}.kicker{font-size:12px;font-weight:800;letter-spacing:1.5px;fill:#72cfff}.title{font-size:28px;font-weight:800;fill:#f5f9ff}.claim{font-size:17px;font-weight:700;fill:#dceaff}.body{font-size:14px;fill:#dce9f8}.small{font-size:12px;fill:#bdd0e2}.gold{font-size:14px;font-weight:800;fill:#f3c743}.head{font-size:15px;font-weight:800;fill:#f5f9ff}.card,.scene,.step,.hyp{fill:#0d2741;stroke:#397daa;stroke-width:1.4}.warn{fill:#382335;stroke:#ff825f;stroke-width:1.8}.hero,.rqactive{fill:#102d4b;stroke:#f3c743;stroke-width:1.8}.rail{fill:#0b2138;stroke:#4b84ad;stroke-width:1.3}.railtext{font-size:13px;fill:#dce9f8}.curve{stroke:#58aee8;stroke-width:4;fill:none}.curvewarn{stroke:#ff825f;stroke-width:4;fill:none}.target{stroke:#f3c743;stroke-width:3;stroke-dasharray:7 5}.mean{fill:#ff825f}.robust{fill:#63dfa2}.arrow,.bigarrow{stroke:#72cfff;stroke-width:3;fill:none}.bigarrow{stroke-width:5}.chain{font-size:24px;font-weight:800;fill:#f3c743}.weight{fill:#58aee8}'''
    return f'<html><style>{css}</style><svg viewBox="0 0 1600 780"><defs><marker id="arrow" markerWidth="10" markerHeight="10" refX="8" refY="4" orient="auto"><path d="M0,0 L0,8 L9,4z" fill="#dceaff"/></marker></defs>{"".join(p)}</svg></html>'
