...
def cluster_map_svg(run, generation, phase, show_inheritance=True, show_eliminated=True, show_grid=True, show_path=True):
    ...
    return f'''<html><style>body{{margin:0;background:#081525;font-family:Arial,sans-serif}}svg{{width:100%;height:480px}}.grid{{stroke:#214664;stroke-dasharray:2 6}}.gen{{font-size:16px;font-weight:800;fill:#edf6ff}}.best{{fill:none;stroke:#b879ff;stroke-width:3;stroke-dasharray:5 4}}.phase{{font-size:15px;font-weight:700;fill:#f3c743}}.hint{{font-size:12px;fill:#aebed3}}</style><svg viewBox="0 0 {width} {height}"><defs><marker id="arrow" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3z" fill="#dceaff"/></marker></defs>{grid}{''.join(frames)}{path_svg}{''.join(links)}{''.join(clouds)}{''.join(labels)}<text x="50" y="470" class="phase">GEN {generation}: {phase_label}</text><text x="330" y="470" class="hint">columns are real populations; colours encode fitness</text></svg></html>'''
