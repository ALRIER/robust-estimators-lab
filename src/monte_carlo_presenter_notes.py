...
MONTE_CARLO_PRESENTER_NOTES = {
    "monte_carlo_measurement": (
        ...
        [
            "This is the full Monte Carlo explanation. Layer 2 now only explains why known-truth simulation is needed.",
            "Step 1: choose one regime. Fix the family, contamination conditions and sample size.",
            "Step 2: generate one synthetic sample from that regime.",
            "Step 3: apply every estimator to the same sample. This keeps the comparison fair inside the replicate.",
            "Step 4: compare every estimate with the same known theta. I use squared error.",
            "Step 5: repeat many times. Repeated errors reveal the estimator risk distribution.",
            "Layer 4 then adds the mathematical summary of those repeated losses.",
            "Replicate-level loss is: T_j of x_r minus theta, all squared.",
            "Mean MSE summarizes average squared error. q95 summarizes the difficult upper-tail part of the error distribution.",
            "The sentence to remember is: choose a regime, generate, estimate, compare with theta, repeat, then summarize risk.",
        ],
        "Now that the measurement engine is clear, I need to show why the simulated world itself was validated before search.",
    ),
