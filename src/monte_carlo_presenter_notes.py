...
MONTE_CARLO_PRESENTER_NOTES = {
    ...
    "monte_carlo_validation_stages": (
        ...
        [
            "WHAT IS THIS?|Before trusting GA evidence, I check that the simulated world behaves as designed.",
            "FOUR CHECKS|Moments · contamination · known theory · empirical anchoring.",
            "RESULT HIGHLIGHTS|These are the outcomes I need to remember.",
            "CHECK 1 · MOMENTS|Maximum mean error = 0.976%, below the 1% hard threshold.",
            "CHECK 2 · CONTAMINATION|Realised contamination rate and MAD-based severity were checked after injection.",
            "CHECK 3 · THEORY|Clean Normal recovers the expected result: mean beats median in MSE.",
            "CHECK 4 · EMPIRICAL|Five public datasets anchor realistic shapes; this is calibration, not known-truth validation.",
            "WARNINGS|29 warnings remained visible. Hard failures = 0.",
        ],
