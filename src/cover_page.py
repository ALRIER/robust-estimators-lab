...
The cover introduces the formal thesis title, the candidate and supervisor,
and a compact four-step preview of the defense journey. It does not recompute
research evidence or replace the detailed roadmap and methods layers.
"""
...
def render_cover_page() -> None:
    """Render the full-width defense cover and preserve navigation actions."""
    st.markdown(
        dedent(
            """
            <style>
              .cover-wrap{max-width:1480px;margin:.2rem auto 0;font-family:Arial,sans-serif;color:#eef6ff}
              .cover-hero{position:relative;overflow:hidden;border:1px solid #2d6d9c;border-radius:22px;
                ...
                box-shadow:0 24px 70px rgba(0,0,0,.25);padding:34px 42px 30px}
              ...
              .cover-kicker{font-size:13px;font-weight:900;letter-spacing:.16em;color:#f3c743;margin-bottom:12px}
              .cover-title{font-family:Georgia,serif;font-size:52px;line-height:1.07;font-weight:800;color:#fff;margin:0 auto 11px;text-shadow:0 0 28px rgba(88,174,232,.13)}
              .cover-subtitle{font-size:20px;line-height:1.38;font-weight:750;color:#cfe2f5;max-width:1090px;margin:0 auto}
              .cover-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin:17px auto 14px;max-width:760px}
              ...
              .cover-descriptor{font-size:17px;line-height:1.43;color:#f3c743;font-style:italic;max-width:1010px;margin:0 auto 20px}

              .identity{position:relative;z-index:2;display:grid;grid-template-columns:1fr 1fr .9fr;gap:0;align-items:center;max-width:1120px;margin:0 auto 24px;background:rgba(9,30,51,.54);border:1px solid #244f72;border-radius:14px;overflow:hidden}
              .identity-block{padding:15px 20px;min-height:82px;display:flex;flex-direction:column;justify-content:center}
              ...
              .identity-value{font-size:21px;font-weight:900;color:#fff;line-height:1.18}
              .identity-sub{font-size:12px;line-height:1.38;color:#b9ccdf;margin-top:4px}
              .uni{text-align:center;align-items:center}.uni img{display:block;max-width:250px;width:100%;margin:auto;background:#fff;border-radius:7px;padding:6px}

              .journey-label{position:relative;z-index:2;text-align:center;font-size:12px;font-weight:900;letter-spacing:.13em;color:#72cfff;margin:3px 0 11px}
              ...
              .journey-card{background:linear-gradient(145deg,rgba(15,43,71,.95),rgba(8,29,50,.95));border:1px solid #356e99;border-radius:16px;padding:17px 15px 16px;min-height:190px;text-align:center}
              ...
              .journey-icon{width:50px;height:50px;border-radius:50%;margin:0 auto 9px;display:flex;align-items:center;justify-content:center;background:#102a45;border:1px solid #3c7198;font-size:24px;font-weight:900;color:#fff}
              .journey-num{font-size:9.5px;font-weight:900;letter-spacing:.11em;color:#9db5ca;margin-bottom:4px}
              .journey-head{font-size:18px;font-weight:900;color:#fff;margin-bottom:6px;line-height:1.18}.journey-copy{font-size:13px;line-height:1.4;color:#c9d9e8}
              .journey-arrow{display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:900;color:#72cfff}

              .cover-boundary{position:relative;z-index:2;background:#0f2d46;border:1px solid #3d7197;border-left:5px solid #f3c743;border-radius:12px;margin-top:17px;padding:12px 15px;text-align:center;font-size:14px;line-height:1.43;color:#e8f4ff}
              .cover-foot{position:relative;z-index:2;display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:15px;padding-top:14px;border-top:1px solid #244f72}
              .foot-item{text-align:center;font-size:12px;line-height:1.38;color:#aebfd0}.foot-item b{display:block;color:#eaf4ff;font-size:12px;letter-spacing:.04em;margin-bottom:2px}

              @media(max-width:1180px){
                .cover-title{font-size:44px}.identity{grid-template-columns:1fr 1fr}.uni{grid-column:1/3;border-left:0!important;border-top:1px solid #2c5c82}.journey{grid-template-columns:1fr 26px 1fr;row-gap:14px}.journey .journey-arrow:nth-of-type(4){display:none}
              }
              @media(max-width:760px){
                .cover-hero{padding:26px 22px}.cover-title{font-size:36px}.cover-subtitle{font-size:17px}.identity{grid-template-columns:1fr}.identity-block+.identity-block{border-left:0;border-top:1px solid #2c5c82}.uni{grid-column:auto}.journey{grid-template-columns:1fr}.journey-arrow{transform:rotate(90deg)}.cover-foot{grid-template-columns:1fr}
              }
            </style>
            """
        ),
